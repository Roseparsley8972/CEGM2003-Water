...
y_pred_valid.to_csv(f'model_validation_predictions_errors_50_{x_group[0]}_{trees}trees_mf{max_features}_{k_num}fold_out.csv', index=False)

print('Saving file')
y_pred_aus.to_csv(f'model_predictions_aus_{x_group[0]}_{trees}trees_mf{max_features}_{k_num}fold_out.csv', index=False)
